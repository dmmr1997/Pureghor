...
import { X, Plus, Trash2, Image as ImageIcon, Sparkles, Upload, Check, AlertCircle, Eye, Loader2 } from 'lucide-react';
...
export const AdminProductModal: React.FC<AdminProductModalProps> = ({
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 15 * 1024 * 1024) {
      addToast('ছবির সাইজ সর্বোচ্চ 15MB হতে পারে', 'error');
      return;
    }
    ...
    try {
      ...
      setImagesText(prev => (prev ? `${imageUrl}\n${prev}` : imageUrl));
      addToast('ছবি সফলভাবে আপলোড এবং অপ্টিমাইজ হয়েছে!', 'success');
    } catch (err: any) {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <span>{isUploadingImage ? 'অপ্টিমাইজ হচ্ছে...' : 'ছবি আপলোড (Upload)'}</span>
                </button>
              </div>
            </div>
