...
import { Image as ImageIcon, Plus, Trash2, Edit3, CheckCircle2, XCircle, X, Upload, Sparkles, Eye, Save, Loader2 } from 'lucide-react';
...
export const AdminBanners: React.FC = () => {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>, target: 'hero' | 'modal') => {
    ...
    try {
      ...
      if (target === 'hero') {
        ...
        addToast('ব্যানার ছবি সফলভাবে আপলোড হয়েছে!', 'success');
      }
    } catch (err: any) {
